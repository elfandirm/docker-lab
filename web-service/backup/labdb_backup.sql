...
\restrict Skm7C9oIrjZVluvx7nwR6hak7BmvSuIWAZQ53VCMW0onbR4qkUCk9f1JRHMPZAO
...
1	2026-05-10 16:45:24.972472	INFO	web-app	User login	{"ip": "192.168.1.10", "user": "admin"}
\.
...
1	3122600001	Ahmad Fauzi	A	1	ahmad@student.pens.ac.id	2026-05-10 16:14:04.777321
2	3122600002	Budi Santoso	A	1	budi@student.pens.ac.id	2026-05-10 16:14:04.777321
3	3122600003	Citra Dewi	B	2	citra@student.pens.ac.id	2026-05-10 16:14:04.777321
\.
...
SELECT pg_catalog.setval('app.activity_log_id_seq', 1, true);
...
SELECT pg_catalog.setval('app.mahasiswa_id_seq', 4, true);
...
SELECT pg_catalog.setval('app.matakuliah_id_seq', 4, true);
...
SELECT pg_catalog.setval('app.nilai_id_seq', 4, true);
...
\unrestrict Skm7C9oIrjZVluvx7nwR6hak7BmvSuIWAZQ53VCMW0onbR4qkUCk9f1JRHMPZAO
